...
hadoop jar JavaHDFS-0.0.1-SNAPSHOT.jar JavaHDFS.JavaHDFS.Part1.DecompressFiles hdfs://cshadoop1/user/<NetID>/Assignment1/Part1/

5) Enter the following command " hdfs dfs -ls /user/<NetID>/Assignment1/Part1 " to see the uncompressed .txt files on hadoop cluster.

6) Enter the following command " hdfs dfs -cat /user/<NetID>/Assignment1/Part1/<any file name>.txt " to see the contents of text file.